# Generated by Django 3.2.8 on 2022-03-21 16:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('PriceTrackerApp', '0004_merge_0003_alter_game_gameid_0003_auto_20220302_2120'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fn', models.CharField(default='', max_length=120)),
                ('ln', models.CharField(default='', max_length=120)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('userGameID', models.CharField(default='', max_length=100)),
                ('gameID', models.CharField(default='', max_length=100)),
                ('userID', models.CharField(default='', max_length=100)),
            ],
        ),
        migrations.RemoveField(
            model_name='vendorurl',
            name='vendor',
        ),
        ...
        migrations.AddField(
            model_name='game',
            name='bestVendor',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='PriceTrackerApp.vendor'),
        ),
        migrations.AddField(
            model_name='game',
            name='lowestPrice',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='USD', max_digits=7),
        ),
        migrations.AddField(
            model_name='game',
            name='lowestPrice_currency',
